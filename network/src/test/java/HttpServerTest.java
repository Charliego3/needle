	...
	public void testListenAndServe() {
		try {
			...
			HttpServer.newInstance()
					  ...
					  .handle(HttpMethod.POST, "/test2", this::t1Handler)
					  .handle(HttpMethod.OPTIONS, "/test3", this::t1Handler)
					  .handle(HttpMethod.CONNECT, "/test5", this::t1Handler)
					  .handle(HttpMethod.DELETE, "/test6", this::t1Handler)
					  .handle(HttpMethod.HEAD, "/test7", this::t1Handler)
					  .handle(HttpMethod.PUT, "/test8", this::t1Handler)
					  .handle(HttpMethod.TRACE, "/test9", this::t1Handler)
					  .handle(HttpMethod.PATCH, "/test10", this::t1Handler)
